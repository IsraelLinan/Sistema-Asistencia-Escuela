...
class TeacherIngressModule(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(title_box, text="Registro de Docentes",
        ...
        self.barcode_entry = ctk.CTkEntry(
            ...
            fg_color=COLORS["bg3"], border_color="#22c55e",
    ...
    def register_salida(self):
        ...
        try:
            ...
            if ingreso_row:
                ...
                self._set_status("⚠  No hay ingreso pendiente para este docente.", COLORS["warning"])
            cur.close()
            db_pool.put_conn(conn)
        except Exception as e:
            messagebox.showerror("Error BD", str(e))
